...
[![Version](https://img.shields.io/badge/version-v1.2.0-blue?style=for-the-badge&logo=windows)](https://github.com/TroniePh/SmartMacroAI/releases)
...
1. Tải file `SmartMacroAI_Setup_v1.2.0.exe` từ [**Releases**](https://github.com/TroniePh/SmartMacroAI/releases/latest)
...
3. Biên dịch script (tuỳ chọn chỉ định phiên bản, ví dụ `1.2.0`):

```powershell
& "${env:ProgramFiles(x86)}\Inno Setup 6\ISCC.exe" installer\SmartMacroAI_Setup.iss /DMyAppVersion=1.2.0
```

4. File cài đặt nằm tại `installer_out\SmartMacroAI_Setup_v1.2.0.exe`.
